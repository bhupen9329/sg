...
class SoudaRateController extends Controller
{
    ...
    {
        $this->middleware('permission:Conversion Rate-index', ['only' => ['index']]);
        $this->middleware('permission:Conversion Rate-create', ['only' => ['create', 'store']]);
        $this->middleware('permission:Conversion Rate-edit', ['only' => ['update', 'edit']]);
        $this->middleware('permission:Conversion Rate-delete', ['only' => ['delete']]);
