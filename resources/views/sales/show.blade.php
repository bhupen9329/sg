        ...
        <div class="dashboard-header pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('/sales') }}">Sales Order Details</a></li>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Sales Order Info</h5>
                            <div class="text-end ">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                @if (!empty($sales_data))
                                                    ...
                                                    <tr>
                                                        <th class="font-weight-bold">SO Number​</th>
