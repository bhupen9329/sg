                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="date" class="form-control" name="date"
                                            value="{{ $currentDate }}" id="raised_date_input" onchange="setDueDate()" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <textarea class="form-control" name="terms_condition" placeholder="Enter Remarks" id="floatingTextarea"
