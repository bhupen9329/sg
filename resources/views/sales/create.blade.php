...
@section('content')
    ...
    <main id="main" class="main">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <input type="text"
                                                                            ...
                                                                            name="total_quantity" id="overall_total_quantity"
        ...
        <select name="item_subcategory[]" class="form-control smaller-font subcategory-select"  id="subcategory_${lastItemId}" style="height: 28px; width: 210px;" required>
            <option value="" selected>Select Subcategory</option>
                                                            ...
                                                            cell3.innerHTML =
                                                                `
        <input type="number" name="qty[]" id="qty_${lastItemId}" class="form-control smaller-font" oninput="updateOveralltotal_quantity()" style="height: 34px; width: 105px"  placeholder="Qty" min="1"  required>`;


                                                            cell4.innerHTML =
                                                                `
        <input type="number" name="amount[]" value="0" id="amount${lastItemId}" class="form-control smaller-font" oninput="updateOveralloverall_total_amount()" style="height: 34px; width: 101px" placeholder="Amount"    required  >`;
    ...
    <script>
        ...
        function updateOveralloverall_total_amount() {
            const weightInputs = document.querySelectorAll('[id^="amount"]');
