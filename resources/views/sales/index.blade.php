                            ...
                            <table class="table " id="Category_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!in_array($data->so_dispatch_item_status, ['Close', 'Pre Closed', 'Cancelled']))
                                            <a href="{{ route('so_pre_close_report', $data->so_item_id) }}"
                                                onclick="return confirm('Are you sure you want to Pre Close this SO item?')"
