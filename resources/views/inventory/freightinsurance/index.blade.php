...
@section('title', 'Freight Rate - Saraswati Globals')
@section('content')
    <main id="main" class="main">
        ...
        <div class="dashboard-header pagetitle">
            <h1>Freight Insurance Rate</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item">Freight Insurance Rate</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                        ...
                        <div class="card-body">
                            <div class="row ">
                                <div class="col-md-6 col-sm-12">
                                    <div class="pd-20">
                                        <h4 class="text-blue h4">Freight Insurance Rate</h4>
                                ...
                                <div class="col-md-6 col-sm-12 d-flex justify-content-end ">
                                    <div class="btn-group">
                                        @can('Sub-Category-create')
                                            @can('price')
                                                <a class="btn btn-primary mb-4 mr-3 "href="{{ route('freight_rate.create') }}">Add
                                                    New
                                                    Freight Insurance Rate</a>
                                            @endcan
                                        @endcan
                            ...
                            <table class="table" id="Category_table">
                                ...
                                <tbody>
                                    @foreach ($freight_rate as $data)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ date('d-M-Y', strtotime($data->freight_rate_date)) }}</td>
                                            <td>{{ $data->freight_rate ?? 'N/A'}}</td>                                           
                                            <td>{{ $data->insurance_rate ?? 'N/A'}}</td>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                        <li>
                                                            @can('Sub-Category-view')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('freight_rate.edit', $data->id) }}"><i
                                                        ...
                                                        <li>
                                                            @can('Sub-Category-delete')
                                                                <form method="POST"
                                                                    action="{{ route('freight_rate.delete', $data->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
