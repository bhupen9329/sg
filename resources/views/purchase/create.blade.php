                                                ...
                                                <div class="btn-list">
                                                    ...
                                                    <script>
                                                        ...
                                                        function addRow() {
                                                            ...
                                                            cell3.innerHTML =
                                                                `
                                                            <input type="number" name="qty[]" id="qty_${lastItemId}" step="any" class="form-control smaller-font" oninput="calculatePrice('${lastItemId}')" style="height: 34px; width: 105px"  placeholder="Qty" min="1"  required>`;
